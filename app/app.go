...
import (
	...
	ntimodule "nti/x/nti"
	ntimodulekeeper "nti/x/nti/keeper"
	ntimoduletypes "nti/x/nti/types"
...
type App struct {
	*baseapp.BaseApp
	...
	NtiKeeper ntimodulekeeper.Keeper
...
func New(
	...
	app.NtiKeeper = *ntimodulekeeper.NewKeeper(
		appCodec,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(ntimoduletypes.ModuleName)
