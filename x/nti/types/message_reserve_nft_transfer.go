...
func NewMsgReserveNftTransfer(creator string, srcNftHash string, srcChain string, srcAddr string, destChain string, destAddr string, blockHeight int32, fungibleToken int32) *MsgReserveNftTransfer {
