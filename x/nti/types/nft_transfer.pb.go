...
func (m *NftTransfer) String() string { return proto.CompactTextString(m) }
func (*NftTransfer) ProtoMessage()    {}
func (*NftTransfer) Descriptor() ([]byte, []int) {
	return fileDescriptor_631eeae614a1e360, []int{0}
}
...
func (m *NftTransfer) GetIndex() string {
	if m != nil {
		return m.Index
	}
	return ""
...
func (m *NftTransfer) GetSrcNftHash() string {
	if m != nil {
		return m.SrcNftHash
	}
	return ""
...
func (m *NftTransfer) GetSrcChain() string {
	if m != nil {
		return m.SrcChain
	}
	return ""
...
func (m *NftTransfer) GetSrcAddr() string {
	if m != nil {
		return m.SrcAddr
	}
	return ""
...
func (m *NftTransfer) GetDestNftHash() string {
	if m != nil {
...
func (m *NftTransfer) GetDestChain() string {
	if m != nil {
		return m.DestChain
	}
	return ""
...
func (m *NftTransfer) GetDestAddr() string {
	if m != nil {
		return m.DestAddr
	}
	return ""
...
func (m *NftTransfer) GetCreatedAt() int32 {
	if m != nil {
		return m.CreatedAt
	}
	return 0
...
func init() {
	proto.RegisterType((*NftTransfer)(nil), "nti.nti.NftTransfer")
}

func init() { proto.RegisterFile("nti/nft_transfer.proto", fileDescriptor_631eeae614a1e360) }

var fileDescriptor_631eeae614a1e360 = []byte{
	// 244 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *NftTransfer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.CreatedAt != 0 {
		i = encodeVarintNftTransfer(dAtA, i, uint64(m.CreatedAt))
		i--
		dAtA[i] = 0x40
	}
	if len(m.DestAddr) > 0 {
		...
		i = encodeVarintNftTransfer(dAtA, i, uint64(len(m.DestAddr)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.DestChain) > 0 {
		...
		i = encodeVarintNftTransfer(dAtA, i, uint64(len(m.DestChain)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.DestNftHash) > 0 {
		...
		i = encodeVarintNftTransfer(dAtA, i, uint64(len(m.DestNftHash)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.SrcAddr) > 0 {
		...
		i = encodeVarintNftTransfer(dAtA, i, uint64(len(m.SrcAddr)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.SrcChain) > 0 {
		...
		i = encodeVarintNftTransfer(dAtA, i, uint64(len(m.SrcChain)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.SrcNftHash) > 0 {
		...
		i = encodeVarintNftTransfer(dAtA, i, uint64(len(m.SrcNftHash)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Index) > 0 {
		i -= len(m.Index)
		copy(dAtA[i:], m.Index)
		i = encodeVarintNftTransfer(dAtA, i, uint64(len(m.Index)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *NftTransfer) Size() (n int) {
	...
	if m.CreatedAt != 0 {
		n += 1 + sovNftTransfer(uint64(m.CreatedAt))
	}
	return n
}
